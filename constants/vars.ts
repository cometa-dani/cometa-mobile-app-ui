...
// supabase
export const supabaseUrl = process.env.EXPO_PUBLIC_SUPABASE_URL || 'https://ynlqvrticeutltbgimpj.supabase.co';
export const supabaseAnonimousKey = process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlubHF2cnRpY2V1dGx0YmdpbXBqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzM0NDk3NzMsImV4cCI6MjA0OTAyNTc3M30.W-ooTltFiYpdFKGLcGGLb8QTJ9DJEzqjOMsxypoPTc4';
